...
# create dedicated namespace for french client
ns = api.namespace('french', description='Operations for french word to phonetic client')
...
class W2POnceFR(Resource):
    ...
    def post(self):
        ...
        try:
            results = g2p_mapping_once(input, settings.FR_MODEL_NAME)
